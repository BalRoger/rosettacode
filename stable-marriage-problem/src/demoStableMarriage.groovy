// Translation of: Java
// (more or less) Uses explicit maps for preference ranking rather than list position. Uses Man and
// Woman enumerated types instead of string names, in order to take advantage of compile time type
// and constant checking to help keep the playas straight without a scorecard.
...
Map<Woman,Map<Man,Integer>> womansManRanking = [
